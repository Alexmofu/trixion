...
?>
    ...
    <div class="sidebar noselect">
        ...
        <a class="selectedSidebar" id="support"><img src="./public/img/faicons/life-ring-solid.svg">Support</a>
    ...
    <!-- Content -->
    <div class="content">
        <div id="main" class="main">  <!-- Main Landing -->
           


        <div class='support noselect mqr'>
        <h2>Support</h2>
        <div class='supportcontent'>
            <span>Fill the following form if you need any kind of assistance</span>
            <span id="supportformFeedback"></span>
            <div class='supportform'>

                <form id="supportForm">
                    <input type='text' name='supportusername' class='supportformInput' placeholder='Username'>
                    <input type='email' name='supportemail' class='supportformInput' placeholder='Email'>
                    <select class='supportformInput' name='supportsubject'>
                    ...
                    <textarea style="min-height: 150px;" id="supporttextarea" class='supportformInput no-mqr' name='supportTextarea' placeholder='Comment'></textarea>
                    <input type='button' id='supportsendbtn' class='supportbtn' value='Submit'>
                </form>
